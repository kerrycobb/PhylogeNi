...
# TODO: Impliment this and decide if it would be better

  NodeKind = enum nkLeaf, nkInner, nkRoot 

  # Node*[T] = ref object 
    # Not yet possible, see https://github.com/nim-lang/RFCs/issues/368
    # This is the proposed solution but doesn't work yet:
    # case kind: NodeKind
    # of nkInner, nkLeaf:
    #   parent*: Node[T]
    # else: discard
